...
int Player::init()
{
	...
	skey = speaker.main_rc[index]->get_value_as_string("skey");
	name = speaker.main_rc[index]->get_value_as_string("name");
...
//	avatar = speaker.main_rc[index]->get_value_as_string("avatar");
	...
	total_board = speaker.main_rc[index]->get_value_as_int("total_board");
	total_win = speaker.main_rc[index]->get_value_as_int("total_win");
//	best_cards = speaker.main_rc[index]->get_value_as_string("best_cards");
//	pcount = speaker.main_rc[index]->get_value_as_int("play_count");
